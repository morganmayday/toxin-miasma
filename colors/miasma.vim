...
" fork for morganmayday/toxin-miasma
...
hi ColorColumn guifg=NONE guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
hi Comment guifg=#666666 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi Constant guifg=#c0bb6e guibg=NONE guisp=NONE blend=NONE gui=NONE
hi CursorColumn guifg=NONE guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi Cursor guifg=#1c2426 guibg=#536841 guisp=NONE blend=NONE gui=NONE
...
hi DiagnosticDeprecated guifg=NONE guibg=NONE guisp=#536841 blend=NONE gui=strikethrough
hi DiagnosticError guifg=#63b242 guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi DiagnosticSignError guifg=#63b242 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
...
hi DiagnosticSignWarn guifg=#536841 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
...
hi DiagnosticVirtualTextError guifg=#63b242 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextHint guifg=#78824b guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextInfo guifg=#78824b guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextWarn guifg=#536841 guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
hi DiagnosticVirtualTextWarning guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticWarn guifg=#536841 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticWarningFloating guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiagnosticWarning guifg=#63b242 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi DiffAdded guifg=#5f875f guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi DiffAdd guifg=#1c2426 guibg=#5f875f guisp=NONE blend=NONE gui=NONE
hi DiffChange guifg=#1c2426 guibg=#536841 guisp=NONE blend=NONE gui=NONE
hi DiffDelete guifg=#1c2426 guibg=#63b242 guisp=NONE blend=NONE gui=bold
hi DiffRemoved guifg=#63b242 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi DiffText guifg=#1c2426 guibg=#c9a554 guisp=NONE blend=NONE gui=bold
hi Directory guifg=#78824b guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi Error guifg=#c2c2b0 guibg=#c0bb6e guisp=NONE blend=NONE gui=NONE
hi ErrorMsg guifg=#63b242 guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
...
hi Folded guifg=#63b242 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi Function guifg=#78834b guibg=NONE guisp=NONE blend=NONE gui=NONE
hi gitCommitBranch guifg=#63b242 guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi gitCommitUnmergedFile guifg=#536841 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi gitCommitUnmergedType guifg=#536841 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi GitSignsAdd guifg=#5f875f guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi GitSignsChange guifg=#536841 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi GitSignsDelete guifg=#63b242 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
...
hi IncSearch guifg=#1c2426 guibg=#c0bb6e guisp=NONE blend=NONE gui=NONE
hi Keyword guifg=#5f875f guibg=NONE guisp=NONE blend=NONE gui=NONE
hi LazyButtonActive guifg=#1c2426 guibg=#78834b guisp=NONE blend=NONE gui=NONE
hi LazyButton guifg=NONE guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
...
hi LazyH1 guifg=#78834b guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
hi LazyH2 guifg=#78834b guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
...
hi lessVariable guifg=#63b242 guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi LspBorderBG guifg=#536841 guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
...
hi MasonHighlight guifg=#78824b guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
...
hi mustacheMarker guifg=#c0bb6e guibg=NONE guisp=NONE blend=NONE gui=NONE
hi mustachePartial guifg=#c0bb6e guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi mustacheVariableUnescape guifg=#536841 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi netrwClassify guifg=#666666 guibg=NONE guisp=NONE blend=NONE gui=bold
hi netrwExe guifg=#536841 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi NonText guifg=#666666 guibg=NONE guisp=NONE blend=NONE gui=bold
hi Normal guifg=#D7C483 guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
hi Number guifg=#78824b guibg=NONE guisp=NONE blend=NONE gui=NONE
hi NvimInternalError guifg=#1c1c1c guibg=#63b242 guisp=NONE blend=NONE gui=NONE
hi phpIdentifier guifg=#63b242 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi phpSpecialFunction guifg=#c0bb6e guibg=NONE guisp=NONE blend=NONE gui=NONE
...
hi PmenuSel guifg=#1c2426 guibg=#78834b guisp=NONE blend=NONE gui=NONE
...
hi RedrawDebugClear guifg=#1c2426 guibg=#c9a554 guisp=NONE blend=NONE gui=NONE
hi RedrawDebugComposed guifg=#1c2426 guibg=#78834b guisp=NONE blend=NONE gui=NONE
hi RedrawDebugNormal guifg=NONE guibg=NONE guisp=NONE blend=NONE gui=reverse
hi RedrawDebugRecompose guifg=#1c2426 guibg=#c0bb6e guisp=NONE blend=NONE gui=NONE
hi ScrollbarCursor guifg=#1c2426 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarCursorHandle guifg=#1c2426 guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi ScrollbarError guifg=#536841 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarErrorHandle guifg=#536841 guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
...
hi ScrollbarGitChange guifg=#536841 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarGitChangeHandle guifg=#536841 guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi ScrollbarGitDelete guifg=#63b242 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarGitDeleteHandle guifg=#63b242 guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
...
hi ScrollbarMisc guifg=#c0bb6e guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarMiscHandle guifg=#c0bb6e guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
...
hi ScrollbarWarn guifg=#63b242 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi ScrollbarWarnHandle guifg=#63b242 guibg=#1c1c1c guisp=NONE blend=0 gui=NONE
hi Search guifg=#1c2426 guibg=#5f875f guisp=NONE blend=NONE gui=NONE
hi shDerefSimple guifg=#63b242 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi SignColumn guifg=#666666 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
hi Special guifg=#c0bb6e guibg=NONE guisp=NONE blend=NONE gui=NONE
hi SpecialKey guifg=#d7c483 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi SpellBad guifg=#536841 guibg=NONE guisp=#d7c483 blend=NONE gui=underline
hi SpellCap guifg=#5f875f guibg=NONE guisp=#d7c483 blend=NONE gui=underline
hi SpellLocal guifg=#c0bb6e guibg=NONE guisp=#d7c483 blend=NONE gui=underline
hi SpellRare guifg=#63b242 guibg=NONE guisp=#d7c483 blend=NONE gui=underline
hi Statement guifg=#5f875f guibg=NONE guisp=NONE blend=NONE gui=bold
hi StatusLine guifg=#d7c483 guibg=#1c2426 guisp=NONE blend=NONE gui=bold
hi StatusLineNC guifg=#666666 guibg=#1c2426 guisp=NONE blend=NONE gui=bold
hi String guifg=#536841 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi SyntasticErrorSign guifg=#63b242 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi SyntasticWarningSign guifg=#536841 guibg=NONE guisp=NONE blend=NONE gui=NONE
hi TabLineFill guifg=#c9a554 guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
...
hi TabLineSep guifg=#111111 guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
hi TelescopeBorder guifg=#536841 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
...
hi TelescopePromptBorder guifg=#63b242 guibg=#1c1c1c guisp=NONE blend=NONE gui=NONE
...
hi Title guifg=#63b242 guibg=NONE guisp=NONE blend=NONE gui=bold
...
hi User1 guifg=#d7c483 guibg=#c0bb6e guisp=NONE blend=NONE gui=NONE
hi User2 guifg=#d7c483 guibg=#666666 guisp=NONE blend=NONE gui=NONE
hi User3 guifg=#d7c483 guibg=#63b242 guisp=NONE blend=NONE gui=NONE
hi User4 guifg=#d7c483 guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
hi User5 guifg=#d7c483 guibg=#c0bb6e guisp=NONE blend=NONE gui=NONE
...
hi User8 guifg=#d7c483 guibg=#63b242 guisp=NONE blend=NONE gui=NONE
hi User9 guifg=#d7c483 guibg=#666666 guisp=NONE blend=NONE gui=NONE
hi VertSplit guifg=#1c1c1c guibg=#1c2426 guisp=NONE blend=NONE gui=NONE
hi Visual guifg=#1c2426 guibg=#78824b guisp=NONE blend=NONE gui=NONE
hi WarningMsg guifg=#63b242 guibg=NONE guisp=NONE blend=NONE gui=NONE
